...
module.exports = {
    ...
    run: async(client, message, args) => {
       if(message.guild.id == "655109296400367618") return client.emit("error", new ShibaError("You can't use this command in this server because salvage gets butthurt"))
