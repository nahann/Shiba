...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if(args[0] > bankToken) return  message.reply({ embeds: [client.embed({ description: `You don't have that much money in your bank account.`}, message)]})
        ...
        message.reply({ embeds: [client.embed({ description: `You have withdrawed ${args[0]} from your bank account.`}, message)]})
    }
}
